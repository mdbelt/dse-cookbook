...
default['opscenter']['ldap']['server_port'] = 389
default['opscenter']['ldap']['ldap_security'] = 'None'
default['opscenter']['ldap']['uri_scheme'] = node['opscenter']['ldap']['ldap_security'].eql?('None') ? 'ldap' : 'ldaps'
